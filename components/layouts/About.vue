<template>
  ...
  >
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-12 gap-4 lg:gap-8 items-center min-h-[400px] py-8 lg:py-16">
        <div
          ref="profileImageSection"
          class="col-span-12 lg:col-span-6 flex justify-center lg:justify-start order-2 lg:order-1
        ...
        <div
          ...
          class="col-span-12 lg:col-span-6 order-1 lg:order-2 opacity-0 transition-all
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-12 gap-4 lg:gap-8 items-start min-h-[400px] py-8 lg:py-16">
        ...
        <div
          ...
          class="col-span-12 lg:col-span-9 leading-[1.67] tracking-[2px] lg:tracking-[4px]
          text-base sm:text-lg lg:text-xl opacity-0 transition-all
          duration-1000 ease-out transform"
          :class="{ 'opacity-100 translate-x-0': isImportantContentVisible }"
        >
          <div class="font-bold mb-6">
            <span class="flex flex-col sm:flex-row items-start sm:items-center text-lg sm:text-xl lg:text-2xl mb-4">
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-12 gap-4 lg:gap-8 items-start py-8 lg:py-16">
        <div
